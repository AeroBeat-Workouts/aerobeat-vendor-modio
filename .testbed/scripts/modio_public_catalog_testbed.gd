...
const SCENE_GROUP_ID := "public_catalog"
const SCENE_DESCRIPTION := "Public provider seam reads: ping, game detail, mod browse/detail/files/stats, tags, metadata, team, dependencies, and authentication terms."
