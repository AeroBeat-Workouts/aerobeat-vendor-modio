...
const SCENE_GROUP_ID := "safe_write"
const SCENE_DESCRIPTION := "Low-risk reversible sandbox writes: subscribe, unsubscribe, and positive rating against a sample sandbox mod. Paid/team/S2S write lanes remain guarded out of this scene."
