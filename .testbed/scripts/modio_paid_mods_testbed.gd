...
const SCENE_DESCRIPTION := "Paid-mod read slice: token packs, wallet, purchased mods, monetization-team reads, and S2S transaction history when configured. Checkout, entitlement sync, and other paid writes stay guarded."
