...
- the current AeroBeat-facing read on direct mod.io checkout should stay documented as a safer current fit for some non-store-controlled distribution contexts, not as a final legal/product ruling; the adapter still preserves the REST contract itself, while the paid-workout / DMCA / provider legal sufficiency question remains pending firmer confirmation
