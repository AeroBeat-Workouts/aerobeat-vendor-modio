...
- the upload seam still intentionally does **not** import local file-path helpers, archive inspection, chunk/workflow orchestration, cloud cook flows, platform-management helpers, or monetization helpers into this vendor seam
