...
- modfile CRUD intentionally does **not** import local file-path helpers, archive inspection, multipart session orchestration, source-modfile flows, cloud cook flows, or platform-management helpers into this vendor seam
