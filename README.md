...
- response normalization seams
  - access token, logout/message, terms, agreement, user, game, mod list/detail, modfiles, mod stats, mod dependants, mod tags, mod metadata KVP, mod team, mod comments, guides, guide comments, collections, collection comments, user-social lists, user/account collection lists, user ratings, subscriptions, dependencies, and collection compatibility writes
