...
1.11. "Patent Claims" of a Contributor
    ...
    made, importing, or transfer of either its Contributions or its
    Contributor Version.
...
2.1. Grants
    ...
    (a) under intellectual property rights (other than patent or
        ...
        basis, with other Modifications, or as part of a Larger Work;
        and
...
2.3. Limitations on Grant Scope
    ...
    (b) for infringements caused by: (i) Your and any other third
        ...
        combination of Covered Software with other software (except as
        part of a Contributor Version); or
...
3.2. Distribution of Executable Form
    ...
    (a) such Covered Software must also be made available in Source Code
        ...
        recipients of the Executable Form how they can obtain such
...
3.6. Distribution of Meager Modifications
    A "Meager Modification" is a Modification that consists only of
    whitespace, spelling, grammatical, or other similar minor changes to
    comments or code, or changes that are made solely to comply with
    standards or requirements of a particular community or project. You
    may distribute a Meager Modification under the terms of this License
    or a license that is compatible with this License.
